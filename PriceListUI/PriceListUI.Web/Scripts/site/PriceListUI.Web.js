...
(function (PriceListUI) {
    ...
    (function (Setup) {
        var ItemRow;
        (function (ItemRow) {
            ItemRow.idProperty = 'RecId';
            ItemRow.nameProperty = 'Code';
            ItemRow.localTextPrefix = 'Setup.Item';
            var Fields;
            (function (Fields) {
            })(Fields = ItemRow.Fields || (ItemRow.Fields = {}));
            ['RecId', 'UnitRecId', 'Code', 'Name', 'UnitRecCode', 'UnitRecName'].forEach(function (x) { return Fields[x] = x; });
        })(ItemRow = Setup.ItemRow || (Setup.ItemRow = {}));
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    ...
    (function (Setup) {
        ...
        (function (ItemService) {
            ItemService.baseUrl = 'Setup/Item';
            var Methods;
            (function (Methods) {
            })(Methods = ItemService.Methods || (ItemService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ItemService[x] = function (r, s, o) { return Q.serviceRequest(ItemService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = ItemService.baseUrl + '/' + x;
            });
        })(ItemService = Setup.ItemService || (Setup.ItemService = {}));
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    ...
    (function (Setup) {
        ...
        UnitForm.formKey = 'Setup.Unit';
        Setup.UnitForm = UnitForm;
        [['Code', function () { return Serenity.StringEditor; }], ['Name', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(UnitForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    ...
    (function (Setup) {
        ...
        (function (UnitRow) {
            ...
            ['RecId', 'Code', 'Name'].forEach(function (x) { return Fields[x] = x; });
        })(UnitRow = Setup.UnitRow || (Setup.UnitRow = {}));
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    ...
    (function (Setup) {
        ...
        (function (UnitService) {
            UnitService.baseUrl = 'Setup/Unit';
            var Methods;
            (function (Methods) {
        ...
        })(UnitService = Setup.UnitService || (Setup.UnitService = {}));
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
...
(function (PriceListUI) {
    ...
    (function (Setup) {
        var VendorRow;
        (function (VendorRow) {
            VendorRow.idProperty = 'RecId';
            VendorRow.nameProperty = 'Address';
            VendorRow.localTextPrefix = 'Setup.Vendor';
            var Fields;
            (function (Fields) {
...
(function (PriceListUI) {
    ...
    (function (Setup) {
        ...
        (function (VendorService) {
            VendorService.baseUrl = 'Setup/Vendor';
            var Methods;
            (function (Methods) {
            })(Methods = VendorService.Methods || (VendorService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                VendorService[x] = function (r, s, o) { return Q.serviceRequest(VendorService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = VendorService.baseUrl + '/' + x;
            });
        })(VendorService = Setup.VendorService || (Setup.VendorService = {}));
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
...
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var ItemDialog = (function (_super) {
            __extends(ItemDialog, _super);
            function ItemDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Setup.ItemForm(_this.idPrefix);
                return _this;
            }
            ItemDialog.prototype.getFormKey = function () { return Setup.ItemForm.formKey; };
            ItemDialog.prototype.getIdProperty = function () { return Setup.ItemRow.idProperty; };
            ItemDialog.prototype.getLocalTextPrefix = function () { return Setup.ItemRow.localTextPrefix; };
            ItemDialog.prototype.getNameProperty = function () { return Setup.ItemRow.nameProperty; };
            ItemDialog.prototype.getService = function () { return Setup.ItemService.baseUrl; };
            return ItemDialog;
        }(Serenity.EntityDialog));
...
(function (PriceListUI) {
    ...
    (function (Setup) {
        var ItemEditor = (function (_super) {
            ...
            function ItemEditor(container) {
                return _super.call(this, container) || this;
            }
            ItemEditor.prototype.getColumnsKey = function () { return 'Setup.Item'; };
            ItemEditor.prototype.getDialogType = function () { return Setup.ItemEditorDialog; };
            ItemEditor.prototype.getLocalTextPrefix = function () { return Setup.ItemRow.localTextPrefix; };
            return ItemEditor;
        }(PriceListUI.Common.GridEditorBase));
        ItemEditor = __decorate([
            Serenity.Decorators.registerClass()
        ], ItemEditor);
        Setup.ItemEditor = ItemEditor;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
...
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var ItemEditorDialog = (function (_super) {
            __extends(ItemEditorDialog, _super);
            function ItemEditorDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Setup.ItemForm(_this.idPrefix);
                return _this;
            }
            ItemEditorDialog.prototype.getFormKey = function () { return Setup.ItemForm.formKey; };
            ItemEditorDialog.prototype.getLocalTextPrefix = function () { return Setup.ItemRow.localTextPrefix; };
            ItemEditorDialog.prototype.getNameProperty = function () { return Setup.ItemRow.nameProperty; };
            return ItemEditorDialog;
        }(PriceListUI.Common.GridEditorDialog));
        ItemEditorDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], ItemEditorDialog);
        Setup.ItemEditorDialog = ItemEditorDialog;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var ItemGrid = (function (_super) {
            __extends(ItemGrid, _super);
            function ItemGrid(container) {
                return _super.call(this, container) || this;
            }
            ItemGrid.prototype.getColumnsKey = function () { return 'Setup.Item'; };
            ItemGrid.prototype.getDialogType = function () { return Setup.ItemDialog; };
            ItemGrid.prototype.getIdProperty = function () { return Setup.ItemRow.idProperty; };
            ItemGrid.prototype.getLocalTextPrefix = function () { return Setup.ItemRow.localTextPrefix; };
            ItemGrid.prototype.getService = function () { return Setup.ItemService.baseUrl; };
            return ItemGrid;
        }(Serenity.EntityGrid));
        ItemGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], ItemGrid);
        Setup.ItemGrid = ItemGrid;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    ...
    (function (Setup) {
        var UnitDialog = (function (_super) {
            ...
            function UnitDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Setup.UnitForm(_this.idPrefix);
                return _this;
            }
            UnitDialog.prototype.getFormKey = function () { return Setup.UnitForm.formKey; };
            UnitDialog.prototype.getIdProperty = function () { return Setup.UnitRow.idProperty; };
            UnitDialog.prototype.getLocalTextPrefix = function () { return Setup.UnitRow.localTextPrefix; };
            UnitDialog.prototype.getNameProperty = function () { return Setup.UnitRow.nameProperty; };
            UnitDialog.prototype.getService = function () { return Setup.UnitService.baseUrl; };
            return UnitDialog;
        }(Serenity.EntityDialog));
...
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var UnitEditor = (function (_super) {
            __extends(UnitEditor, _super);
            function UnitEditor(container) {
                return _super.call(this, container) || this;
            }
            UnitEditor.prototype.getColumnsKey = function () { return 'Setup.Unit'; };
            UnitEditor.prototype.getDialogType = function () { return Setup.UnitEditorDialog; };
            UnitEditor.prototype.getLocalTextPrefix = function () { return Setup.UnitRow.localTextPrefix; };
            return UnitEditor;
        }(PriceListUI.Common.GridEditorBase));
        UnitEditor = __decorate([
            Serenity.Decorators.registerClass()
        ], UnitEditor);
        Setup.UnitEditor = UnitEditor;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var PriceListUI;
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var UnitEditorDialog = (function (_super) {
            __extends(UnitEditorDialog, _super);
            function UnitEditorDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Setup.UnitForm(_this.idPrefix);
                return _this;
            }
            UnitEditorDialog.prototype.getFormKey = function () { return Setup.UnitForm.formKey; };
            UnitEditorDialog.prototype.getLocalTextPrefix = function () { return Setup.UnitRow.localTextPrefix; };
            UnitEditorDialog.prototype.getNameProperty = function () { return Setup.UnitRow.nameProperty; };
            return UnitEditorDialog;
        }(PriceListUI.Common.GridEditorDialog));
        UnitEditorDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], UnitEditorDialog);
        Setup.UnitEditorDialog = UnitEditorDialog;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    ...
    (function (Setup) {
        var UnitGrid = (function (_super) {
            ...
            UnitGrid.prototype.getColumnsKey = function () { return 'Setup.Unit'; };
            UnitGrid.prototype.getDialogType = function () { return Setup.UnitDialog; };
            UnitGrid.prototype.getIdProperty = function () { return Setup.UnitRow.idProperty; };
            UnitGrid.prototype.getLocalTextPrefix = function () { return Setup.UnitRow.localTextPrefix; };
            UnitGrid.prototype.getService = function () { return Setup.UnitService.baseUrl; };
            return UnitGrid;
        }(Serenity.EntityGrid));
        UnitGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], UnitGrid);
        Setup.UnitGrid = UnitGrid;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var VendorDialog = (function (_super) {
            __extends(VendorDialog, _super);
            function VendorDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Setup.VendorForm(_this.idPrefix);
                return _this;
            }
            VendorDialog.prototype.getFormKey = function () { return Setup.VendorForm.formKey; };
            VendorDialog.prototype.getIdProperty = function () { return Setup.VendorRow.idProperty; };
            VendorDialog.prototype.getLocalTextPrefix = function () { return Setup.VendorRow.localTextPrefix; };
            VendorDialog.prototype.getNameProperty = function () { return Setup.VendorRow.nameProperty; };
            VendorDialog.prototype.getService = function () { return Setup.VendorService.baseUrl; };
            return VendorDialog;
        }(Serenity.EntityDialog));
        ...
        Setup.VendorDialog = VendorDialog;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var PriceListUI;
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var VendorEditor = (function (_super) {
            __extends(VendorEditor, _super);
            function VendorEditor(container) {
                return _super.call(this, container) || this;
            }
            VendorEditor.prototype.getColumnsKey = function () { return 'Setup.Vendor'; };
            VendorEditor.prototype.getDialogType = function () { return Setup.VendorEditorDialog; };
            VendorEditor.prototype.getLocalTextPrefix = function () { return Setup.VendorRow.localTextPrefix; };
            return VendorEditor;
        }(PriceListUI.Common.GridEditorBase));
        VendorEditor = __decorate([
            Serenity.Decorators.registerClass()
        ], VendorEditor);
        Setup.VendorEditor = VendorEditor;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var PriceListUI;
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var VendorEditorDialog = (function (_super) {
            __extends(VendorEditorDialog, _super);
            function VendorEditorDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Setup.VendorForm(_this.idPrefix);
                return _this;
            }
            VendorEditorDialog.prototype.getFormKey = function () { return Setup.VendorForm.formKey; };
            VendorEditorDialog.prototype.getLocalTextPrefix = function () { return Setup.VendorRow.localTextPrefix; };
            VendorEditorDialog.prototype.getNameProperty = function () { return Setup.VendorRow.nameProperty; };
            return VendorEditorDialog;
        }(PriceListUI.Common.GridEditorDialog));
        VendorEditorDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], VendorEditorDialog);
        Setup.VendorEditorDialog = VendorEditorDialog;
    })(Setup = PriceListUI.Setup || (PriceListUI.Setup = {}));
})(PriceListUI || (PriceListUI = {}));
var PriceListUI;
(function (PriceListUI) {
    var Setup;
    (function (Setup) {
        var VendorGrid = (function (_super) {
            __extends(VendorGrid, _super);
            function VendorGrid(container) {
                return _super.call(this, container) || this;
            }
            VendorGrid.prototype.getColumnsKey = function () { return 'Setup.Vendor'; };
            VendorGrid.prototype.getDialogType = function () { return Setup.VendorDialog; };
            VendorGrid.prototype.getIdProperty = function () { return Setup.VendorRow.idProperty; };
            VendorGrid.prototype.getLocalTextPrefix = function () { return Setup.VendorRow.localTextPrefix; };
            VendorGrid.prototype.getService = function () { return Setup.VendorService.baseUrl; };
            return VendorGrid;
        }(Serenity.EntityGrid));
