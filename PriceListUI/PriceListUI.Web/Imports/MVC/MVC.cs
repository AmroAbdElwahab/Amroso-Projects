...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Setup
        {
            ...
            {
                public const string ItemIndex = "~/Modules/Setup/Item/ItemIndex.cshtml";
            }

            public static class Unit
            {
                public const string UnitIndex = "~/Modules/Setup/Unit/UnitIndex.cshtml";
            }

            public static class Vendor
            {
                public const string VendorIndex = "~/Modules/Setup/Vendor/VendorIndex.cshtml";
            }
        }
        ...
        public static class Transactions
        {
            ...
            {
                public const string PurchIndex = "~/Modules/Transactions/Purch/PurchIndex.cshtml";
            }
        }
    }
}
